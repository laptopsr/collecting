                    ...
                    <div class="col-lg-12">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li>  <a href="<?php echo Yii::app()->request->baseUrl.'/index.php/collectorRows/admin'; ?>">kerättävien tuotteiden hallinta</a></li>
...
<div class="portlet portlet-default">
  <div class="portlet-heading">
      <div class="portlet-title">
         <h4>Muokkaa kerätävää tuotetta #<?php echo $model->id; ?></h4>
      </div>
